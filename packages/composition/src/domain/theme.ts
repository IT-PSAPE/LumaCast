...
// refactor decision D2): the three per-owner theme entities. Presentation,
// lyric, and overlay themes each have their own table and their own
...
// (compare the old app/core/theme-capabilities.ts, now deleted). The three
