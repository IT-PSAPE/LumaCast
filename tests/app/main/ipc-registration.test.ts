 ...
 * tests/app/main/application-menu.test.ts: `vi.mock('electron', ...)` with
...
import { MediaDerivativeService } from '../../../app/main/media-derivatives';
import { MediaLibraryService } from '../../../app/main/media-library';
import { maskManagedMediaSource, revokeManagedMediaSource } from '../../../app/main/media-capability';
