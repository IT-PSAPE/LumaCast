...
import { BinShell, type BinGridConfig } from '../../../../../app/renderer/components/layout/bin-shell';
import { WorkbenchProvider } from '@renderer/contexts/workbench-context';
import { BinControlsProvider, BinControlsSearchField, BinControlsViewOptions, useBinControls } from '../../../../../app/renderer/components/controls/bin-controls';
