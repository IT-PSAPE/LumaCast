...
import { buildLyricTextElement, normalizeLyricText, parseLyricImportText } from '../../../../../app/renderer/features/items/lyric-text-utils';
import { DEFAULT_LYRIC_LAYOUT_CONFIG, type LyricLayoutConfig } from '../../../../../app/renderer/features/items/lyric-layout-config';
