...
vi.mock('../../../../../app/renderer/features/playback/ndi-capture-source', () => ({
  useNdiCaptureSource: () => null,
}));

vi.mock('../../../../../app/renderer/features/playback/ndi-readback-worker?worker', () => ({
...
} from '../../../../../app/renderer/features/playback/ndi-frame-capture';
