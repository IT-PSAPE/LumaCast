...
import { AppProvider, useAppStore, useCast, useNdi, useNdiLiveState } from '../../../../app/renderer/contexts/app-context';
...
vi.mock('../../../../app/renderer/features/observability/metrics-store', () => ({
  recordObsEvent,
}));
