...
import { NavigationProvider, useNavigationActions } from '../../../../../app/renderer/contexts/navigation-context';
import type { NavigationActionsValue } from '../../../../../app/renderer/types/navigation-context-types';
...
describe('applyThemeToItem call-site boundary', () => {
  ...
  it('keeps direct applyThemeToItem calls confined to the authoritative command', () => {
    const rendererRoot = path.resolve(__dirname, '../../../../../app/renderer');
