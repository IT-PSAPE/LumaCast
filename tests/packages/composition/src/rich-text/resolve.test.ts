...
import type { TextElementPayload } from '../../../../../packages/composition/src/domain/slide-elements';
import { richBodyToText } from '../../../../../packages/composition/src/rich-text/serialize';
import { boxStyleFromPayload, coerceWeight, resolveRun, synthesizePlain } from '../../../../../packages/composition/src/rich-text/resolve';
