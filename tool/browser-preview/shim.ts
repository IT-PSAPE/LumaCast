...
const castApi = {
  ...
  chooseDeckBundleExportPath: noop,
  chooseDeckBundleImportPath: noop,
  chooseImportReplacementMediaPath: noop,
  exportDeckBundle: noop,
  ...
  createLibrary: noop,
  createPlaylist: noop,
  createPlaylistGroup: noop,
  renamePlaylistGroup: noop,
  setPlaylistGroupColor: noop,
  movePlaylist: noop,
  addDeckItemToGroup: noop,
  moveDeckItemToGroup: noop,
  movePlaylistEntryToGroup: noop,
  movePlaylistEntry: noop,
  moveDeckItem: noop,
  ...
  setSlideOrder: noop,
  setLibraryOrder: noop,
  setPlaylistOrder: noop,
  setPlaylistGroupOrder: noop,
  movePlaylistEntryTo: noop,
  createElement: noop,
  ...
  updateTheme: noop,
  deleteTheme: noop,
  applyThemeToDeckItem: noop,
  detachThemeFromDeckItem: noop,
  syncThemeToLinkedDeckItems: noop,
  applyThemeToOverlay: noop,
  createDeckItemWithTheme: noop,
  duplicateDeckItem: noop,
  createStage: noop,
  updateStage: noop,
  deleteStage: noop,
  duplicateStage: noop,
  ...
  reorderCollections: noop,
  setItemCollection: noop,
